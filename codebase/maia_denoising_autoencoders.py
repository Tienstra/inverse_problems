...
# noisy image
f = x_train[1].reshape(28,28)
f_delta = x_train_noisy[1].reshape(28,28)
...
x_noisy_flat= x_train_noisy[1].flatten()
...
ax[2].imshow(u_admm.reshape(28,28))
ax[2].set_title('Result ADMM')
ax[2].set_xticks([])
ax[2].set_yticks([])
